...
| :--- | :--- | :--- | :--- | :--- |
| **Mantota** | Réseau publicitaire, social commerce et IA commerciale (OD IA) pour l'Afrique francophone | Laravel 12, Vue 3, MySQL, Tailwind v3 | En production (v1.0), v2.0 en dev | [odsystem-bit/mantota](https://github.com/odsystem-bit/mantota) |
